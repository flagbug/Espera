...
namespace Espera.View.ViewModels
{
    public class SettingsViewModel : ReactiveObject
    {
            ...
            IWindowManager windowManager, Guid accessToken, MobileApiInfo mobileApiInfo)
        {
            ...
            canCreateAdmin = this
                .WhenAnyValue(x => x.CreationPassword, x => !string.IsNullOrWhiteSpace(x) && !isAdminCreated)
            ...
            canLogin = this.WhenAnyValue(x => x.LoginPassword, x => !string.IsNullOrWhiteSpace(x))
