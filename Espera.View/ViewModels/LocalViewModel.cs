...
namespace Espera.View.ViewModels
{
    public class LocalViewModel : SongSourceViewModel<LocalSongViewModel>
    {
            ...
            : base(library, coreSettings, accessToken)
        {
            ...
            {
                int songIndex = SelectableSongs.TakeWhile(x => x.Model != SelectedSongs.First().Model).Count();
        ...
        private void UpdateArtists()
        {
            ...
            List<ArtistViewModel> artistsToRemove = allArtists.Where(x => !groupedByArtist.Contains(x.Name)).ToList();
            ...
            {
                ArtistViewModel model = allArtists.FirstOrDefault(x =>
        ...
        private void UpdateSelectableSongs()
        {
            ...
            List<LocalSongViewModel> selectableSongs = filteredSongs
                .Where(group =>
